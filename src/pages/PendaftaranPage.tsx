...
import merchImage from "@/assets/baju-gyd.jpeg";
  ...
  return (
    <div className="min-h-screen bg-parchment">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        {/* Layout for side-by-side image and main content on larger screens */}
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          {/* Main content container */}
          <div className="bg-background rounded-2xl shadow-xl p-6 sm:p-10 border border-border flex-1">
          ...
          <div className="lg:w-[400px] w-full shrink-0">
            <div className="bg-background rounded-2xl shadow-xl overflow-hidden border border-border sticky top-8 p-4">
               <img src={merchImage} alt="Desain Kaos GYD 2026" className="w-full h-auto rounded-lg" />
            </div>
          </div>
        </div>
      </div>
